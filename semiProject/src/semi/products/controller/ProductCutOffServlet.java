...
/**
 * Servlet implementation class ProductCutOffServlet
 */
@WebServlet("/cutoff")
public class ProductCutOffServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductCutOffServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//해당 페이지에 보이게할 목록 조회
			ArrayList<Product> list = pservice.cutOffSelectList(currentPage, limit);
