...
/**
 * Servlet implementation class ProductChargeServlet
 */
@WebServlet("/charge")
public class ProductChargeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductChargeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 게시글 페이지별 조회 처리용 컨트롤러
				...
				try {
					...
					//해당 페이지에 보이게할 목록 조회
					ArrayList<Product> list = pservice.chargeSelectList(currentPage, limit);
